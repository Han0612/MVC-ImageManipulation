...
public class ImageManipulatorModelImpl implements ImageManipulatorModel {
  ...
  @Override
  public void dither(String srcImageName, String destImageName) {
    Image srcImg = checkAndGetTheImage(srcImageName);
    if (srcImg == null) {
      return;
    }

    ImageFilter ditherFilter = new DitherFilter();
    addImageToHashMap(destImageName, ditherFilter.applyFilterToImage(srcImg));
  }
